...
public class MumbleService extends Service {
	...
	public int handleCommand(final Intent intent) {
		...
		final AudioOutputSettings audioSettings =
			new AudioOutputSettings();

		final SharedPreferences preferences =
			PreferenceManager.getDefaultSharedPreferences(this);
		audioSettings.useJitter = preferences.getString(
			Preferences.PREF_JITTER,
			Preferences.ARRAY_JITTER_NONE).equals(Preferences.ARRAY_JITTER_SPEEX);

		audioSettings.stream = preferences.getString(
			Preferences.PREF_STREAM,
			Preferences.ARRAY_STREAM_MUSIC).equals(Preferences.ARRAY_STREAM_MUSIC)
