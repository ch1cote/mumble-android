...
public class MumbleProtocol implements Protocol {
	...
	public MumbleProtocol(
		MumbleProtocolHost host,
		AudioOutputHost audioHost,
	...
	public void processTcp(final short type, final byte[] buffer)
		...
		case CryptSetup:
			...
			if (cryptsetup.hasKey() && cryptsetup.hasClientNonce() &&
				...
				nonceBuilder.setClientNonce(conn.getNonce());
